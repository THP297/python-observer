...
def applyFilter(filters, filtered_data):
    ...
    for i, row in filtered_data.iterrows():
        ...
        action_button_cog_id = {"type": "ongoing-action-button-cog", "key": unique_key}
        action_button_flag_id = {"type": "ongoing-action-button-flag", "key": unique_key}
        action_menu_id = {"type": "ongoing-action-menu", "key": unique_key}
        ...
        action_cell = html.Td([
            html.Div(
                [
                    ...
                    # Action button for flag
                    html.Button(
                        [html.I(className="fas fa-flag")],
                        id=action_button_flag_id,
                        n_clicks=0,
                        style={
                            "backgroundColor": "transparent",
                            "border": "none",
